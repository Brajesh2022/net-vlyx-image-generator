...
function ViewAllContent() {
  ...
  const { data, isLoading, error, refetch } = useQuery({
    queryKey: ["/api/scrape", category, currentPage],
    queryFn: async () => {
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold mb-2">{getCategoryLabel(category)}</h1>
            <p className="text-gray-400">Browse all {getCategoryLabel(category).toLowerCase()}</p>
          </div>
